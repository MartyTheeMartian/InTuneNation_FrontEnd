...
2. do an NPM install inside your terminal to obtain necessary node modules,
3. and npm start inside your terminal to start up a development server with which you can preview your work at any given time.
